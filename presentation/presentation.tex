...
\begin{frame}{Numerical Analysis --- the NAML core (2/2)}
  ...
  \begin{block}{\small Bootstrap confidence intervals: Monte-Carlo convergence}
    ...
    $\mathrm{SE}_{0.975}\approx \tfrac{1}{f(q)}\sqrt{\tfrac{p(1-p)}{B}}\approx 0.19$\,AP at $B=200$
    --- well below our $\sim$1\,AP resolution. CI \emph{width} is set by patient variance, not by $B$.
  \end{block}
  \centering
