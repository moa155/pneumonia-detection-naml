...
\usepackage{etoolbox}           % \pretocmd, used to force every \section onto a new page

% Force every top-level \section to start on a fresh page (subsections flow normally).
